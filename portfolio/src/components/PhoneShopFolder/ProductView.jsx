        ...
        <main>
            ...
            <div className="wrapper">
                ...
                <div className='productViewContainer'>
                   ...
                   {addedVisible && <div className="product-added-to-shopping-cart">Successfully added to shopping cart<br/> <Link className='go-shopping-cart-button' to='../phone-shop/shopping-cart-view-1'>Go to shopping cart</Link></div>} 
